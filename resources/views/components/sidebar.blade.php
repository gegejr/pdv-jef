...
<div id="sidebar" class="bg-white w-64 h-screen shadow-md fixed top-0 left-0 z-40 transition-all duration-300">
    ...
    <nav class="p-4 space-y-2">
        ...
        <!-- Dropdown -->
            <div x-show="open" class="pl-6 mt-2 space-y-1" x-cloak>
                    <a href="{{ route('clientes') }}" class="block text-gray-700 hover:bg-gray-200 p-2 rounded">Adicionar CLiente</a>
                    <a href="{{ route('cliente.conta') }}" class="block text-gray-700 hover:bg-gray-200 p-2 rounded">
                    Conta Cliente
                    </a>
            </div>
        </div> 
